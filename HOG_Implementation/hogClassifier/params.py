...
master_path_to_dataset = "D:/ComputerVisionAssignment/pedestrain/"; # ** need to edit this ** maybe add more??
...
DATA_training_path_cars,DATA_training_path_motorbike=os.path.join(master_path_to_dataset,"INRIAPerson/Train/car/"),os.path.join(master_path_to_dataset,"INRIAPerson/Train/motorbike/")
