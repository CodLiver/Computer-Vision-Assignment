...
master_path_to_dataset = "/tmp/mjqf76/pedestrain/"; # ** need to edit this ** maybe add more??
...
DATA_training_path_car,DATA_training_path_motorbike=os.path.join(master_path_to_dataset,"INRIAPerson/Train/car/"),os.path.join(master_path_to_dataset,"INRIAPerson/Train/motorbike/")
